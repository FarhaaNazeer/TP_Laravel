...
<body class="page-color-style-6 page-style-6">
    ...
    <div class="main-content">
        ...
        <section class="full-height-slider type-1">
            <div class="bg ready " data-jarallax="5" style="background-image: url(http://unionagency.one/delice/img/contacts/main-baner-bg.jpg)" data-swiper-parallax="50%"></div>
                        ...
                        <div class="contact-instagram no-padd no-padd-sm">
                            <div class="row">
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#"><img src="http://unionagency.one/delice/img/contacts/insta-1.jpg" alt="" class="full-img"></a>
                                </div>
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#"><img src="http://unionagency.one/delice/img/contacts/insta-2.jpg" alt="" class="full-img"></a>
                                </div>
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#"><img src="http://unionagency.one/delice/img/contacts/insta-3.jpg" alt="" class="full-img"></a>
                                </div>
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#"><img src="http://unionagency.one/delice/img/contacts/insta-4.jpg" alt="" class="full-img"></a>
                                </div>
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#"><img src="http://unionagency.one/delice/img/contacts/insta-5.jpg" alt="" class="full-img"></a>
                                </div>
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <a href="#"><img src="http://unionagency.one/delice/img/contacts/insta-6.jpg" alt="" class="full-img"></a>
                                </div>
                            </div>
                        </div>
                        <div class="empty-sm-25 empty-xs-20"></div>
