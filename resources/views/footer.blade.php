<footer class="footer footer-style-1">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <ul class="list-style-3 ul-list">
                                <li><a href="#" class="link-hover">BREAKFAST</a></li>
                                <li><a href="#" class="link-hover">DINNER</a></li>
                                <li><a href="#" class="link-hover">APPETIZERS</a></li>
                            </ul>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <ul class="list-style-3 ul-list">
                                <li><a href="#" class="link-hover">SALADS</a></li>
                                <li><a href="#" class="link-hover">DRINKS</a></li>
                                <li><a href="#" class="link-hover">EXCLUSIVE OFFERS</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="copyright text-center">
        <div class="container">
            <span>© 2021 All Rights Reserved. Development by <a href="#">IndusValley</a></span>
        </div>
