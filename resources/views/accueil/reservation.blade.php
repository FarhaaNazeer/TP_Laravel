...
<body class="page-color-style-6 page-style-6">
    ...
    <div class="main-content">
        ...
        <section class="full-height-slider type-1">
            <div class="bg ready data-jarallax" data-jarallax="5" style="background-image: url(	http://unionagency.one/delice/img/reservation/main-baner-bg.jpg)" data-swiper-parallax="50%"></div>
                            ...
                            c-0.553,0-1,0.447-1,1S31.447,2.5,32,2.5z"></path>
                                ...
                                <div class="col-md-5">
                                    <div class="input-field-icon">
                                        ...
                                        <div class="icon">
                                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 369.946 369.946" width="18px" height="18px" style="enable-background:new 0 0 369.946 369.946;" xml:space="preserve">
                                                <g>
                                                    <g>
                          ...
                          c75.864,0,138.313,56.436,148.028,129.524H41.17C50.884,437.607,113.334,380.708,189.198,380.708z"></path>
                                ...
                                <div class="col-md-7">
                                    <div class="input-field-icon">
                                        ...
                                        <div class="icon">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 29.731 29.731" width="18px" height="18px" style="enable-background:new 0 0 29.731 29.731;" xml:space="preserve">
                                                <g>
                            ...
                            c0-5-4.1-9.1-9.1-9.1H312c-8.1,0-14.7-6.6-14.7-14.7v-88.3c0-8.1,6.6-14.7,14.7-14.7h144.8c8.1,0,14.7,6.6,14.7,14.7V161.95z"></path>
                                                    </g>
                                                </g>
                                                <g></g>
                                                <g></g>
