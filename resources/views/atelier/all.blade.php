                        ...
                        <div class="col-lg-6 col-lg-offset-3 col-sm-12 col-sm-offset-0">
                            <div class="simple-item color-type-1 text-center">
                                <div class="main-title">
                                    <h1 class="h1 caption">Nos ateliers</h1>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="menu-item menu-item-6 type-3">
                        <div class="text">
                            ...
                            <h5 class="h5 caption"><a href="#" class="link-hover-line">{{ $atelier->nom }}</a></h5>
                            <div class="empty-sm-5 empty-xs-5"></div>
                            <div class="simple-text">
                                <p><b>Date: </b>{{ $atelier->date }}</p>
                            </div>
                            <div class="simple-text">
                                <p><b>Localisation: </b>{{ $atelier->location }}</p>
                            </div>
                        </div>
                        <div class="page-button button-style-1 type-2">
                            <input type="submit">
                            <span class="txt">Reserver</span><i></i>
                        </div>
                    </div>
                </div>
                @endforeach
