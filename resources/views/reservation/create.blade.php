                            ...
                            <div class="col-lg-6 col-lg-offset-3 col-sm-12">
                                <div class="simple-item color-type-1 text-center">
                                    <div class="main-title">
                                        <h1 class="h1 caption">Reservations</h1>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="input-field-wrap">
                                        ...
                                        <select name="atelier" id="atelier" class="input-field @error('atelier') is-invalid @enderror">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="input-field-wrap">
                                        ...
                                        <input type="number" name="nb_pers" id="nb_pers" min="0" class="input-field  @error('nb_pers') is-invalid @enderror">
                                        @error('nb_pers')
